package com.my_ecommerce.controller.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<String> handleEntityException(IllegalArgumentException businessException) {
        return ResponseEntity.unprocessableEntity().body(businessException.getMessage());
    }
